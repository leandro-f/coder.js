...
while (tieneOtroCelular) {
  ...
  const respuesta = prompt("Tienes otro celular? ('si' o 'no')");
  if (respuesta   === "no") {
...
//este parte no la inclui porque no puede hacer que cuando el usurio coloque "no" se me repita todas las preguntas
